package com.lachhh.lachhhengine.animation {
	...
	public class FlashAnimationCache {
		...
		public function GetFactoryObject(instanceType:int):MovieClip {
			var gameElement:MovieClip  ;
			var elementsInPool:Array = _cache[instanceType];
			if(elementsInPool != null && elementsInPool.length > 0) {
				gameElement = (elementsInPool.shift() as MovieClip);
			} else {
		...
		public function AddToCache(gameElement:MovieClip):void {
