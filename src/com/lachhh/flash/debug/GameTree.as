package com.lachhh.flash.debug {
	...
	import com.berzerkrpg.scenes.SimpleGameScene;
	...
	public class GameTree {
		...
		private static var _dummyActorTree : DebugManagerActorTree;
		...
		static public function init() : void {
			...
			_dummyActorTree = new DebugManagerActorTree();
			_dummyActorTree.setActor(MainGame.dummyActor);
			_dummyActorTree.name = "DummyActor";
			_logicChild.AddChild(_dummyActorTree);
		...
		private static function AddStarlingChild() : void {
			var child:DebugStarlingTree = new DebugStarlingTree();
