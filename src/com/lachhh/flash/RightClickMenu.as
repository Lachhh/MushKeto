package com.lachhh.flash {
	...
	public class RightClickMenu {
		...
		static public function addRightClickMenu(sprite:Sprite):void {
			...
			_ciVersionInfo = new ContextMenuItemWithCallback("Version 0.1", new Callback(OnDebug, RightClickMenu, null));
			...
			_menusShown.customItems = [_ciBerzerkStudio.contextMenuItem, _ciDebug.contextMenuItem, _ciVersionInfo.contextMenuItem];
