package com.berzerkrpg.io {
	 ...
	 * @author Shayne
	 */
	public class BerzerkUserAPI implements IPIOAccount, IPremiumAPIController {
		
		public static var instance:BerzerkUserAPI;
		...
		private var _usernameForcedForNextLogin:String = "";
		
		public function BerzerkUserAPI(){
		...
		public function forceUsernameForNextLogin(username:String):void{
			_usernameForcedForNextLogin = username;
		}
		...
		private function checkIfLoaded() : void {
			if(!BerzerkStarlingManager.berzerkFlaLoader.isAtlasLoaded(ModelFlaEnum.JSB_UI_TITLEANDPRELOADER)) {
				...
				BerzerkStarlingManager.berzerkFlaLoader.loadFla(ModelFlaEnum.JSB_UI_TITLEANDPRELOADER);
				return ;
			}
			...
			var login:UI_BerzerkLogin = new UI_BerzerkLogin(_usernameForcedForNextLogin);
			_usernameForcedForNextLogin = "";
		...
		private function onLoginUIClose(login:UI_BerzerkLogin):void{
			if(login.lastLoginRequest.isSuccessful){
				...
				_connected = true;
				_loggedIn = true;
				MetaGameProgress.instance.berzerkPalsToken = getAuthToken();
				MetaGameProgress.instance.berzerkPalsUsername = getPioId();
		...
		public function clear():void{
			...
			_connected = false;
			_loggedIn = false;
			MetaGameProgress.instance.berzerkPalsToken = "";
			MetaGameProgress.instance.berzerkPalsUsername = "";
			MetaGameProgress.instance.saveToLocal();
		}
