package com.lachhhStarling {
    ...
    public class OptimizedVertexData 
    {
        /** Each elements size */
        ...
        public function OptimizedVertexData(numVertices:int, premultipliedAlpha:Boolean=false)
        {
        ...
        public function clone(vertexID:int=0, numVertices:int=-1):OptimizedVertexData
        {
            if (numVertices < 0 || vertexID + numVertices > mNumVertices)
                numVertices = mNumVertices - vertexID;
            
            var clone:OptimizedVertexData = new OptimizedVertexData(0, mPremultipliedAlpha);
        ...
        public function copyTo(targetData:OptimizedVertexData, targetVertexID:int=0,
		...
		public function copyTransformedTo(targetData:OptimizedVertexData, targetVertexID:int=0,
                                          matrix:Matrix=null,
                                          vertexID:int=0, numVertices:int=-1):void
        {
            if (numVertices < 0 || vertexID + numVertices > mNumVertices)
            ...
            var targetIndex:int = targetVertexID * BYTES_PER_VERTEX;
            var sourceIndex:int = vertexID * BYTES_PER_VERTEX;
            var sourceEnd:int = (vertexID + numVertices) * BYTES_PER_VERTEX;
        ...
        public function append(data:OptimizedVertexData):void
        {
